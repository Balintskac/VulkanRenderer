...
{
    SwapChainSupportDetails swapChainSupport = VulkanDevice::querySwapChainSupport(p_device, surface);
    ...
    QueueFamilyIndices indices = VulkanQueue::findQueueFamilies(p_device, surface);
